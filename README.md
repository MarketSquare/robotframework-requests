[![Build Status](https://travis-ci.org/Tset-Noitamotua/robotframework-requests.svg?branch=master)](https://travis-ci.org/Tset-Noitamotua/robotframework-requests)
