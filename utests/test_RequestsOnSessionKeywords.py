...
def test_common_request_verify_override_true():
    ...
    session.get.assert_called_with('http://mocking.rules/', timeout=None, cookies={}, verify=True)
...
def test_common_request_verify_override_false():
    ...
    session.get.assert_called_with('http://mocking.rules/', timeout=None, cookies={}, verify=False)
...
def test_common_request_with_cookies_override_default():
    ...
    session.get.assert_called_with('http://mocking.rules/', timeout=None, cookies={'a': 3, 'b': 4})
